...
interface HomeClientProps {
  /** The three latest guides for the teaser strip, summaries only. */
  posts: PostSummary[];
  /** Total published guides, for the "View All" count. */
  postCount: number;
}

export default function HomeClient({ posts, postCount }: HomeClientProps) {
  ...
  // JSON-LD lives in app/page.tsx (server) via lib/schema.ts.
          ...
          <section className="py-16 bg-[#F7F6F2] border-t border-[#E7E5E4] px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto space-y-10">
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                ...
                >
                  <span>View All Guides ({postCount})</span>
