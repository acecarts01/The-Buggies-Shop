...
export default function Footer() {
  return (
    <footer className="bg-[#F7F6F2] text-[#121417] border-t border-[#E7E5E4]">
      ...
      <div className="border-b border-[#E7E5E4] py-8 px-4 bg-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 text-sm">
          <div className="flex items-start gap-3">
            <ShieldCheck className="w-5 h-5 text-[#C86D51] shrink-0 mt-0.5" />
            <div>
          ...
          <div className="flex items-start gap-3">
            <Truck className="w-5 h-5 text-[#C86D51] shrink-0 mt-0.5" />
            <div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-xs">
        ...
        <div className="space-y-3">
          ...
          <div className="p-3 bg-white border border-[#E7E5E4] rounded-xl text-[11px] space-y-1 shadow-xs surface-card">
            ...
            <div className="text-[#78716C]">ACN: {ABN_INFO.acn}</div>
            <div className="flex items-center gap-1.5 pt-0.5">
              <span className="text-[#78716C]">ABN:</span>
              <a
                href={ABN_INFO.officialAbrLink}
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#C86D51] font-bold underline inline-flex items-center gap-1 hover:text-[#A85640]"
            ...
            <div className="text-[#78716C]">Locality: {ABN_INFO.locality}</div>
            <div className="text-[#78716C]">Regulator: {ABN_INFO.regulator}</div>
          </div>
        </div>
          ...
          <ul className="space-y-2">
            {CATEGORIES.slice(0, 6).map((cat) => (
              <li key={cat.slug}>
                <Link
                  ...
                  className="text-[#78716C] hover:text-[#C86D51] transition-colors"
                >
                  {cat.name}
                </Link>
              </li>
            ...
            <li>
              <Link
                ...
                className="text-[#C86D51] font-bold hover:underline"
              >
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/about/" className="text-[#78716C] hover:text-[#C86D51] transition-colors">
                About Our Yatala Depot
              </Link>
            </li>
            <li>
              <Link href="/shop/" className="text-[#78716C] hover:text-[#C86D51] transition-colors">
                Order Now &amp; Nationwide Freight
              </Link>
            </li>
            <li>
              <Link href="/faq/" className="text-[#78716C] hover:text-[#C86D51] transition-colors">
                Frequently Asked Questions (FAQ)
              </Link>
            </li>
            <li>
              <Link href="/blog/" className="text-[#78716C] hover:text-[#C86D51] transition-colors">
            ...
            <li>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#78716C] hover:text-[#C86D51] inline-flex items-center gap-1 transition-colors"
              >
            ...
            <li>
              <a
                ...
                target="_blank"
                className="text-[#C86D51] hover:text-[#A85640] transition-colors"
              >
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2 text-[#78716C]">
            ...
            <a href={`tel:${CONTACT.phone}`} className="hover:text-[#C86D51] font-semibold text-[#121417]">
          ...
          <div className="flex items-center gap-2 text-[#78716C]">
            ...
            <a href="mailto:sales&#64;golfbuggiesexpress.com.au" className="hover:text-[#C86D51]">
      ...
      <div className="border-t border-[#E7E5E4] px-4 py-4 text-center text-[11px] text-[#78716C] bg-white">
